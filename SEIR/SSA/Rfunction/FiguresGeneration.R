...
pl = ReInfectionTimesDF %>%
  ...
  labs(x = "(Re)Infection number - single simulation run", 
...
ggsave(pl,filename = "Plots/InfectionTimes_revised.pdf",device = "pdf",width = 8,height = 5)
...
pl =  ReInfectionTimesDF %>%
  ...
  labs(x = "(Re)Infection number - 1000 simulation runs",
...
ggsave(pl,filename = "Plots/InfectionCounts_revised.pdf",device = "pdf",width = 8,height = 5)
